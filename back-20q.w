...
@* 들어가며.
Don Woods가 만든 {\it 스무 문제\/}(Twenty Questions)는 객관식 시험이다. 문제가
...
원문에서는 매크로 |o|와 |oo|가 이 일을 $C$의 콤마 연산자로 슬쩍 끼워 넣지만
...
\centerline{\bf 표 666}
\smallskip
\centerline{스무 문제 (연습문제 7.2.2--71)}
\qrule
\tabskip=0pt
...
var (
	order = [21]int{0,
		3, 15, 20, 19, 2, 1, 17, 10, 5, 4,
		16, 11, 13, 14, 7, 18, 6, 8, 12, 9}
	loguy, higuy int // 답이 같아도 되는 이웃 한 쌍
	rho = [32]int{-1, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0,
		4, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0} // 5비트 수의 자 함수
)

@ 표 |rho|는 {\it 자 함수\/}(ruler function)다. 인자 $y$의 가장 낮은 $1$비트가
