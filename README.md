...
해설(짚트리, FFT, 리차오 트리, CDQ 분할 정복)이 있고, HackerRank·Library
Checker·Project Euler와 뤄구·POJ·LightOJ·앳코더·CEOI·NOI·HEOI의 문제 풀이가
있으며, 터미널 생명 게임이나 기타 튜너처럼 그 자체로 돌아가는 프로그램도 있다.
문서는 모두 한글로 썼다.
