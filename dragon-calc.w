...
Knuth가 2010년 9월에 \.{CWEB}으로 쓴 \.{dragon-calc.w}인데, 나는 그것을 Go로
...
접기열 뒤에 붙은 널 문자를 파수꾼 삼아 마지막 한 번을 거저 돌지만, Go의 슬라이스에는
...
기계에 따라 죽거나(x86) 엉뚱한 값을 뱉는다(ARM에서 실제로 그랬다). Go는 $0$으로
